...
export default {
  ...
  /**
   * Lookup19: frame_system::EventRecord<shiden_runtime::Event, primitive_types::H256>
   **/
  ...
  /**
   * Lookup29: pallet_identity::pallet::Event<T>
   **/
  PalletIdentityEvent: {
    _enum: {
  ...
  /**
   * Lookup38: pallet_dapps_staking::pallet::pallet::Event<T>
   **/
  PalletDappsStakingPalletEvent: {
    _enum: {
      BondAndStake: '(AccountId32,ShidenRuntimeSmartContract,u128)',
      UnbondUnstakeAndWithdraw: '(AccountId32,ShidenRuntimeSmartContract,u128)',
      NewContract: '(AccountId32,ShidenRuntimeSmartContract)',
      ContractRemoved: '(AccountId32,ShidenRuntimeSmartContract)',
      NewDappStakingEra: 'u32',
      Reward: '(AccountId32,ShidenRuntimeSmartContract,u32,u128)'
    }
  },
  /**
   * Lookup39: shiden_runtime::SmartContract<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup45: pallet_evm::pallet::Event<T>
   **/
  PalletEvmEvent: {
    _enum: {
      Log: 'EthereumLog',
  ...
  /**
   * Lookup51: evm_core::error::ExitReason
   **/
  ...
  /**
   * Lookup52: evm_core::error::ExitSucceed
   **/
  EvmCoreErrorExitSucceed: {
    _enum: ['Stopped', 'Returned', 'Suicided']
  },
  /**
   * Lookup53: evm_core::error::ExitError
   **/
  ...
  /**
   * Lookup56: evm_core::error::ExitRevert
   **/
  EvmCoreErrorExitRevert: {
    _enum: ['Reverted']
  },
  /**
   * Lookup57: evm_core::error::ExitFatal
   **/
  ...
  /**
   * Lookup58: pallet_custom_signatures::pallet::Event<T>
   **/
  ...
  /**
   * Lookup85: pallet_utility::pallet::Call<T>
   **/
  PalletUtilityCall: {
    _enum: {
      batch: {
  ...
  /**
   * Lookup88: pallet_identity::pallet::Call<T>
   **/
  PalletIdentityCall: {
    _enum: {
      add_registrar: {
  ...
  /**
   * Lookup89: pallet_identity::types::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup127: pallet_identity::types::BitFlags<pallet_identity::types::IdentityField>
   **/
  ...
  /**
   * Lookup128: pallet_identity::types::IdentityField
   **/
  ...
  /**
   * Lookup131: pallet_identity::types::Judgement<Balance>
   **/
  ...
  /**
   * Lookup134: pallet_multisig::pallet::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
  ...
  /**
   * Lookup136: cumulus_pallet_parachain_system::pallet::Call<T>
   **/
  ...
  /**
   * Lookup137: cumulus_primitives_parachain_inherent::ParachainInherentData
   **/
  ...
  /**
   * Lookup138: polkadot_primitives::v1::PersistedValidationData<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup152: pallet_dapps_staking::pallet::pallet::Call<T>
   **/
  PalletDappsStakingPalletCall: {
    _enum: {
      register: {
        contractId: 'ShidenRuntimeSmartContract',
      },
      unregister: {
        contractId: 'ShidenRuntimeSmartContract',
      },
  ...
  /**
   * Lookup153: pallet_authorship::pallet::Call<T>
   **/
  ...
  /**
   * Lookup157: pallet_collator_selection::pallet::Call<T>
   **/
  ...
  /**
   * Lookup158: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
        ...
        keys_: 'ShidenRuntimeSessionKeys',
        proof: 'Bytes',
      },
      purge_keys: 'Null'
    }
  ...
  /**
   * Lookup159: shiden_runtime::SessionKeys
   **/
  ShidenRuntimeSessionKeys: {
    aura: 'SpConsensusAuraSr25519AppSr25519Public'
  },
  /**
   * Lookup160: sp_consensus_aura::sr25519::app_sr25519::Public
   **/
  SpConsensusAuraSr25519AppSr25519Public: 'SpCoreSr25519Public',
  /**
   * Lookup161: sp_core::sr25519::Public
   **/
  SpCoreSr25519Public: '[u8;32]',
  /**
   * Lookup162: pallet_evm::pallet::Call<T>
   **/
  PalletEvmCall: {
    _enum: {
      withdraw: {
  ...
  /**
   * Lookup164: pallet_ethereum::pallet::Call<T>
   **/
  PalletEthereumCall: {
    _enum: {
      transact: {
  ...
  /**
   * Lookup165: ethereum::transaction::LegacyTransaction
   **/
  ...
  /**
   * Lookup166: ethereum::transaction::TransactionAction
   **/
  ...
  /**
   * Lookup167: ethereum::transaction::TransactionSignature
   **/
  ...
  /**
   * Lookup169: pallet_custom_signatures::pallet::Call<T>
   **/
  ...
  /**
   * Lookup171: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup172: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup180: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup182: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup184: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup186: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
    _enum: ['MinimumThreshold', 'AlreadyApproved', 'NoApprovalsNeeded', 'TooFewSignatories', 'TooManySignatories', 'SignatoriesOutOfOrder', 'SenderInSignatories', 'NotFound', 'NotOwner', 'NoTimepoint', 'WrongTimepoint', 'UnexpectedTimepoint', 'MaxWeightTooLow', 'AlreadyStored']
  },
  /**
   * Lookup188: polkadot_primitives::v1::UpgradeRestriction
   **/
  ...
  /**
   * Lookup192: polkadot_primitives::v1::AbridgedHrmpChannel
   **/
  ...
  /**
   * Lookup194: polkadot_primitives::v1::AbridgedHostConfiguration
   **/
  ...
  /**
   * Lookup200: polkadot_core_primitives::OutboundHrmpMessage<polkadot_parachain::primitives::Id>
   **/
  ...
  /**
   * Lookup207: pallet_balances::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup208: pallet_balances::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup211: pallet_balances::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup213: pallet_balances::Releases
   **/
  ...
  /**
   * Lookup217: pallet_vesting::Releases
   **/
  PalletVestingReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup218: pallet_vesting::pallet::Error<T>
   **/
  PalletVestingError: {
    _enum: ['NotVesting', 'AtMaxVestingSchedules', 'AmountLow', 'ScheduleIndexOutOfBounds', 'InvalidScheduleParams']
  },
  /**
   * Lookup219: pallet_dapps_staking::Forcing
   **/
  PalletDappsStakingForcing: {
    _enum: ['NotForcing', 'ForceNew', 'ForceNone', 'ForceAlways']
  },
  /**
   * Lookup220: pallet_dapps_staking::EraRewardAndStake<Balance>
   **/
  ...
  /**
   * Lookup222: pallet_dapps_staking::EraStakingPoints<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup227: pallet_dapps_staking::pallet::pallet::Error<T>
   **/
  PalletDappsStakingPalletError: {
    _enum: ['StakingWithNoValue', 'InsufficientValue', 'MaxNumberOfStakersExceeded', 'NotOperatedContract', 'NotStakedContract', 'UnstakingWithNoValue', 'AlreadyRegisteredContract', 'ContractIsNotValid', 'AlreadyUsedDeveloperAccount', 'NotOwnedContract', 'UnknownEraReward', 'NotStaked', 'AlreadyClaimedInThisEra', 'EraOutOfBounds', 'RequiredContractPreApproval', 'AlreadyPreApprovedDeveloper']
  },
  /**
   * Lookup229: pallet_authorship::UncleEntryItem<BlockNumber, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup233: pallet_collator_selection::pallet::CandidateInfo<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup234: pallet_collator_selection::pallet::Error<T>
   **/
  ...
  /**
   * Lookup240: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
    _enum: ['InvalidProof', 'NoAssociatedValidatorId', 'DuplicatedKey', 'NoKeys', 'NoAccount']
  },
  /**
   * Lookup245: pallet_evm::pallet::Error<T>
   **/
  PalletEvmError: {
    _enum: ['BalanceLow', 'FeeOverflow', 'PaymentOverflow', 'WithdrawFailed', 'GasPriceTooLow', 'InvalidNonce']
  },
  /**
   * Lookup248: fp_rpc::TransactionStatus
   **/
  ...
  /**
   * Lookup251: ethbloom::Bloom
   **/
  EthbloomBloom: '[u8;256]',
  /**
   * Lookup253: ethereum::receipt::Receipt
   **/
  EthereumReceipt: {
    stateRoot: 'H256',
    usedGas: 'U256',
  ...
  /**
   * Lookup254: ethereum::block::Block<ethereum::transaction::LegacyTransaction>
   **/
  EthereumBlock: {
  ...
  /**
   * Lookup255: ethereum::header::Header
   **/
  EthereumHeader: {
    parentHash: 'H256',
    ommersHash: 'H256',
  ...
  /**
   * Lookup256: ethereum_types::hash::H64
   **/
  EthereumTypesHashH64: '[u8;8]',
  /**
   * Lookup261: pallet_ethereum::pallet::Error<T>
   **/
  PalletEthereumError: {
    _enum: ['InvalidSignature', 'PreLogExists']
  },
  /**
   * Lookup262: pallet_custom_signatures::pallet::Error<T>
   **/
  ...
  /**
   * Lookup272: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup273: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup274: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup277: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup278: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup279: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup281: shiden_runtime::Runtime
   **/
  ShidenRuntimeRuntime: 'Null'
};
