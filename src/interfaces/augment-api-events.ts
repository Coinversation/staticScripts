...
declare module '@polkadot/api/types/events' {
  ...
  import type { Null, Result, U256, U8aFixed, Vec, u128, u32, u64 } from '@polkadot/types';
  import type { AccountId32, H160, H256 } from '@polkadot/types/interfaces/runtime';
  import type { EthereumLog, EvmCoreErrorExitReason, FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, PalletMultisigTimepoint, ShidenRuntimeSmartContract, SpRuntimeDispatchError } from '@polkadot/types/lookup';
  ...
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    dappsStaking: {
       ...
       **/
      BondAndStake: AugmentedEvent<ApiType, [AccountId32, ShidenRuntimeSmartContract, u128]>;
      /**
       * Contract removed from dapps staking.
       **/
      ContractRemoved: AugmentedEvent<ApiType, [AccountId32, ShidenRuntimeSmartContract]>;
      /**
       * New contract added for staking.
       **/
      NewContract: AugmentedEvent<ApiType, [AccountId32, ShidenRuntimeSmartContract]>;
      /**
       ...
       **/
      Reward: AugmentedEvent<ApiType, [AccountId32, ShidenRuntimeSmartContract, u32, u128]>;
      /**
       * Account has unbonded, unstaked and withdrawn funds.
       **/
      UnbondUnstakeAndWithdraw: AugmentedEvent<ApiType, [AccountId32, ShidenRuntimeSmartContract, u128]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
